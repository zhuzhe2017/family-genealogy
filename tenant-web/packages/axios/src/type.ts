...
> {
   ...
   *
   * If the hook returns a truthy value (e.g. a retried request), the error will be recovered
   *
   * @param error
   * @param instance Axios instance
   */
  onError: (error: AxiosError<ResponseData>, instance: AxiosInstance) => unknown | Promise<unknown>;
}
