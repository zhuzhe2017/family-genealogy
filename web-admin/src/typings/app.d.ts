    ...
    type Schema = {
      ...
      page: {
        ...
        home: {
          ...
          events: string;
          quickActions: string;
          surnameDistribution: string;
          totalSurnames: string;
          updatedAt: string;
          noSurnameData: string;
          surnameRanking: string;
          noData: string;
          membersUnit: string;
          memberTip: string;
          familyTip: string;
        ...
        systemSettings: {
          ...
          passwordRequireUpper: string;
          passwordRequireLower: string;
          passwordRequireNumber: string;
          passwordRequireSpecial: string;
          passwordExpireDays: string;
          passwordExpireDaysTip: string;
          loginSecurity: string;
          loginMaxAttempts: string;
          loginLockoutMinutes: string;
          loginCaptchaEnabled: string;
          loginTokenExpireDays: string;
          ipRestriction: string;
          ipRestrictionEnabled: string;
          ipRestrictionMode: string;
          ipModeBlacklist: string;
          ipModeWhitelist: string;
          ipBlacklist: string;
          ipWhitelist: string;
          ipListTip: string;
          sensitiveVerify: string;
          sensitiveVerifyEnabled: string;
          sensitiveVerifyTimeout: string;
          sensitiveVerifyTimeoutTip: string;
          logType: string;
          ...
          empty: string;
          cloudStorage: string;
          cloudStorageTip: string;
          cloudStorageProvider: string;
          cloudStorageProviderTencent: string;
          cloudStorageProviderAliyun: string;
          cloudStorageProviderQiniu: string;
          cloudStorageEnabled: string;
          cloudStorageDisabled: string;
          cloudStorageEnable: string;
          cloudStorageStatus: string;
          cloudStorageSecretId: string;
          cloudStorageSecretKey: string;
          cloudStorageAccessKey: string;
          cloudStorageAccessKeySecret: string;
          cloudStorageBucket: string;
          cloudStorageRegion: string;
          cloudStorageEndpoint: string;
          cloudStorageDomain: string;
          cloudStorageAppId: string;
          cloudStorageRequired: string;
          cloudStorageSave: string;
          cloudStorageSaveSuccess: string;
          cloudStorageMaskTip: string;
          cloudStorageSensitiveTip: string;
          payConfig: string;
          payConfigTip: string;
          payProvider: string;
          payProviderWxpay: string;
          payProviderAlipay: string;
          payWxEnabled: string;
          payAlipayEnabled: string;
          payAppId: string;
          payMchId: string;
          payMchSerialNo: string;
          payPrivateKey: string;
          payApiV3Key: string;
          payNotifyUrl: string;
          payPlatformPublicKey: string;
          payAlipayPublicKey: string;
          payStatusNotifyUrl: string;
          payRequired: string;
          paySave: string;
          paySaveSuccess: string;
          payTest: string;
          payTestSuccess: string;
          payTestFailed: string;
          payMaskTip: string;
        };
      };
      form: {
