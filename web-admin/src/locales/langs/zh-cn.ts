const local: App.I18n.Schema = {
  ...
  page: {
    ...
    home: {
      ...
      familyCount: '家族数量',
      todayNewFamilies: '今日新增家族',
      pendingAuditContents: '待审核内容',
      paidFamilies: '付费家族数',
      memberCount: '成员总数',
      photoCount: '相册总数',
      contentCount: '内容总数',
      ...
      subscriptionStatsTitle: '订阅与商业化分析',
      last7Days: '近7天',
      last30Days: '近30天',
      last90Days: '近90天',
      customDate: '自定义',
      kpiTotalRevenue: '区间总收入',
      kpiPaidOrders: '付费订单数',
      kpiPaidFamilies: '付费家族数',
      kpiConversionRate: '用户转化率',
      chartSubscriptionGrowth: '订阅用户增长趋势',
      chartRevenue: '商业化收入数据',
      chartConversion: '用户转化率分析',
      chartNewSubscriptions: '新增订阅',
      chartTotalSubscriptions: '累计订阅',
      chartFamilyCount: '新增家族',
      chartPaidCount: '新增付费家族',
      chartConversionRate: '转化率',
      countUnit: '数量',
      subscriptionLoadError: '获取订阅数据失败'
    },
    systemSettings: {
      title: '系统设置',
      ...
      empty: '暂无数据',
      cloudStorage: '云存储配置',
      cloudStorageTip: '配置和管理腾讯云、阿里云、七牛云对象存储服务参数',
      cloudStorageProvider: '当前启用服务商',
      cloudStorageProviderTencent: '腾讯云 COS',
      cloudStorageProviderAliyun: '阿里云 OSS',
      cloudStorageProviderQiniu: '七牛云 Kodo',
      cloudStorageEnabled: '已启用',
      cloudStorageDisabled: '未启用',
      cloudStorageEnable: '启用该配置',
      cloudStorageStatus: '启用状态',
      ...
      cloudStorageBucket: '存储桶名称',
      cloudStorageRegion: '地域 / Region',
      cloudStorageEndpoint: 'Endpoint',
      cloudStorageDomain: '自定义域名',
      cloudStorageAppId: 'AppId',
      cloudStorageRequired: '启用后该项必填',
      cloudStorageSave: '保存云存储配置',
      cloudStorageSaveSuccess: '云存储配置保存成功',
      cloudStorageMaskTip: '敏感信息已脱敏显示，编辑时会清空请重新填写',
      cloudStorageSensitiveTip: '包含敏感信息，请妥善保管',
      payConfig: '支付配置',
      payConfigTip: '配置微信支付与支付宝支付参数，敏感信息加密存储',
      payProvider: '当前支付方式',
      payProviderWxpay: '微信支付',
      payProviderAlipay: '支付宝',
      payWxEnabled: '启用微信支付',
      payAlipayEnabled: '启用支付宝',
      payAppId: 'AppId',
      payMchId: '商户号',
      payMchSerialNo: '证书序列号',
      payPrivateKey: 'API 私钥',
      payApiV3Key: 'API v3 密钥',
      payNotifyUrl: '回调通知 URL',
      payPlatformPublicKey: '微信平台公钥',
      payAlipayPublicKey: '支付宝公钥',
      payStatusNotifyUrl: '支付状态通知 URL',
      payRequired: '启用后该项必填',
      paySave: '保存支付配置',
      paySaveSuccess: '支付配置保存成功',
      payTest: '测试连通',
      payTestSuccess: '支付连通测试通过',
      payTestFailed: '支付连通测试失败',
      payMaskTip: '敏感信息已脱敏显示，编辑时会清空请重新填写'
    }
  },
  form: {
    required: '不能为空',
