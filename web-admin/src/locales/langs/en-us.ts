const local: App.I18n.Schema = {
  ...
  route: {
    ...
    'mini-program_genealogy-book': 'Genealogy Book',
  ...
  page: {
    ...
    home: {
      ...
      todayNewFamilies: 'New Families Today',
      pendingAuditContents: 'Pending Audits',
      paidFamilies: 'Paid Families',
      ...
      subscriptionStatsTitle: 'Subscription & Monetization',
      ...
      kpiPaidFamilies: 'Paid Families',
      kpiConversionRate: 'Conversion Rate',
      chartSubscriptionGrowth: 'Subscription Growth',
      chartRevenue: 'Revenue Data',
      chartConversion: 'Conversion Analysis',
      chartNewSubscriptions: 'New Subscriptions',
      chartTotalSubscriptions: 'Total Subscriptions',
      chartFamilyCount: 'New Families',
      chartPaidCount: 'New Paid Families',
      chartConversionRate: 'Conversion Rate',
      countUnit: 'Count',
    ...
    systemSettings: {
      ...
      cloudStorageTip: 'Configure and manage Tencent, Aliyun and Qiniu object storage parameters',
      cloudStorageProvider: 'Current Provider',
      cloudStorageProviderTencent: 'Tencent COS',
      cloudStorageProviderAliyun: 'Aliyun OSS',
      cloudStorageProviderQiniu: 'Qiniu Kodo',
      cloudStorageEnabled: 'Enabled',
      cloudStorageDisabled: 'Disabled',
      cloudStorageEnable: 'Enable this provider',
      cloudStorageStatus: 'Status',
      cloudStorageSecretId: 'SecretId',
      cloudStorageSecretKey: 'SecretKey',
      cloudStorageAccessKey: 'AccessKey',
      cloudStorageAccessKeySecret: 'AccessKeySecret',
      cloudStorageBucket: 'Bucket',
      cloudStorageRegion: 'Region',
      cloudStorageEndpoint: 'Endpoint',
      cloudStorageDomain: 'Custom Domain',
      cloudStorageAppId: 'AppId',
      cloudStorageRequired: 'Required when enabled',
      cloudStorageSave: 'Save Cloud Storage Config',
      cloudStorageSaveSuccess: 'Cloud storage config saved',
      cloudStorageMaskTip: 'Sensitive values are masked; please re-enter when editing',
      cloudStorageSensitiveTip: 'Contains sensitive information, please keep it safe',
      payConfig: 'Payment Config',
      payConfigTip: 'Configure WeChat Pay and Alipay parameters; sensitive values are encrypted',
      payProvider: 'Current Payment Provider',
      payProviderWxpay: 'WeChat Pay',
      payProviderAlipay: 'Alipay',
      payWxEnabled: 'Enable WeChat Pay',
      payAlipayEnabled: 'Enable Alipay',
      payAppId: 'AppId',
      payMchId: 'Merchant ID',
      payMchSerialNo: 'Certificate Serial No',
      payPrivateKey: 'API Private Key',
      payApiV3Key: 'API v3 Key',
      payNotifyUrl: 'Notify URL',
      payPlatformPublicKey: 'WeChat Platform Public Key',
      payAlipayPublicKey: 'Alipay Public Key',
      payStatusNotifyUrl: 'Status Notify URL',
      payRequired: 'Required when enabled',
      paySave: 'Save Payment Config',
      paySaveSuccess: 'Payment config saved',
      payTest: 'Test Connection',
      payTestSuccess: 'Payment connection test passed',
      payTestFailed: 'Payment connection test failed',
      payMaskTip: 'Sensitive values are masked; please re-enter when editing'
    }
  },
  form: {
