...
Page({
  ...
  getMockEvents() {
    return [
      { id: 1, year: 1880, month: 3, day: 15, title: '张太公出生', description: '家族始祖张太公出生于山东省济南市', type: 'birth', typeName: '出生', relatedMembers: [{ id: '1', name: '张太公' }] },
      { id: 2, year: 1900, month: 5, day: 20, title: '张太公与张太婆成婚', description: '张太公迎娶张太婆，开启家族新篇章', type: 'marriage', typeName: '婚嫁', relatedMembers: [{ id: '1', name: '张太公' }, { id: '2', name: '张太婆' }] },
      { id: 3, year: 1910, month: 8, day: 10, title: '张大出生', description: '长子张大出生', type: 'birth', typeName: '出生', relatedMembers: [{ id: '3', name: '张大' }] },
      { id: 4, year: 1912, month: 2, day: 28, title: '张二出生', description: '次子张二出生', type: 'birth', typeName: '出生', relatedMembers: [{ id: '4', name: '张二' }] },
      { id: 5, year: 1915, month: 11, day: 5, title: '张三出生', description: '三子张三出生', type: 'birth', typeName: '出生', relatedMembers: [{ id: '5', name: '张三' }] },
      { id: 6, year: 1940, month: 6, day: 18, title: '张强出生', description: '张大的长子张强出生', type: 'birth', typeName: '出生', relatedMembers: [{ id: '6', name: '张强' }] },
      { id: 7, year: 1955, month: 8, day: 20, title: '张太公逝世', description: '家族始祖张太公享年75岁', type: 'death', typeName: '逝世', relatedMembers: [{ id: '1', name: '张太公' }] },
